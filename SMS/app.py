...
if choice == "Dropout Risk Predictor":
    ...
    if not df.empty and len(df) > 5:
        ...
        df_ml['attendance'] = np.random.uniform(50, 100, len(df_ml))  # Simulated attendance
        ...
        # Features and target
        features = ['class_numeric', 'age', 'gpa', 'attendance', 'grades']
        X = df_ml[features]
        y = df_ml['dropout']
        ...
        st.dataframe(high_risk[['name', 'class', 'age', 'gpa', 'attendance', 'grades', 'predicted_risk']])
